...
const profileData = { name: 'Abhishek Bharti', point: 200 }

const bookOtherWordsForHome = {
    id: 1,
    bookName: "Other Words For Home",
    bookCover: otherWordsForHome,
    rating: 4.5,
    language: "Eng",
    pageNo: 341,
...
const data = { booksData,  profileData}
export default data